...
router.get('/active/:id', leagueController.getActiveLeagues); // Get active leagues by organization
...
router.patch('/teams/:id', leagueController.addTeamToLeague); // Adds a team to the given league. teamID must be in the body.
